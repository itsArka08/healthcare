            ...
            <div className="col col-lg-6 mb-4 mb-lg-0">
              <div className="card mb-3" style={{ borderRadius: '1rem' }}>
                <div className="row g-0">
                  <div className="col-md-5 text-center text-white" style={{ borderTopLeftRadius: '.5rem', borderBottomLeftRadius: '.5rem', backgroundColor: "#226623" }}>

                    <img src="images/blog/testimonial1.jpg" alt="Avatar" className="img-fluid my-4" style={{ width: 120, height: 120, borderRadius: "100%" }} />
