		...
		{all_dep_data?.data?.map((item, index) => {
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="service-block mb-5">
					<img src="images/service/bg-1.jpg" alt="" class="img-fluid" style={{ height: '200px', objectFit: 'cover' }}/>
					<div class="content">
		...
		<div class="row">
			<div class="col-lg-7">
				<div class="cta-content">
					...
					<Link to="/appoinmentform" class="btn btn-main">Get appoinment<i class="icofont-simple-right  ml-2"></i></Link>
				</div>
			</div>
		</div>
	</div>
