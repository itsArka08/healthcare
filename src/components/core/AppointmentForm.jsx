		...
		{all_dep_data?.data?.map((item, index) => {
			...
			<div class="col-lg-4 col-md-6 ">
				<div class="department-block mb-5">
					<img src="https://media.istockphoto.com/id/1316501954/vector/female-doctor-with-black-hair-standing-hands-in-pocket.jpg?s=612x612&w=0&k=20&c=sTV-oLBqna2ZuEG1qNwZl4LgHj4WtFkrN8bDnHQPBxo=" alt="" class="img-fluid w-100" style={{ height: '200px', objectFit: 'cover' }}/>
					<div class="content">
